...
export const DesktopNav = () => {
    return <nav className='flex z-[10] justify-center fixed w-full lef-0 right-0 top-0 py-[30px] items-center gap-5 px-[20px] '>
       ...
       <Link href='/'><Image className='w-[93.627px] h-[14.655px] ' height={50} width={100} alt='splitev' src={splitevText}/></Link>
            <ul className='flex items-center gap-[34px] pt-[5px] items-start'>
                ...
                <li className='text-[16px] font-[400] text-[#7F847D] leading-[130%]'><Link href='/blog'>Blog</Link></li>
