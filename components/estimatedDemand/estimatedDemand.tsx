...
export const EstimatedDemand = () => {
    return  <div className='flex flex-col gap-y-[48px] overflow-x-hidden items-center '>
    ...
    <div className='flex items-center gap-5 relative flex-reversed py-[50px] '>
        <div className='flex flex-col  justify-center absolute bg-primaryBg top-0 left-[30%]  border-white border border-[2px] shadow-2xl px-[30px] py-[20px] items-center rounded-full '>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="200" viewBox="0 0 240 240" fill="none">
...
<stop offset="0.999452" stop-color="white" stop-opacity="0"/>
            ...
            <h1 className='text-[20px] text-blackText font-[500] leading-[130%] '>
                $1,822.50
            </h1>
            <p className='text-[16px] font-[500] text-textPrimary leading-[130%] '>A YEAR</p>
            </div>
        </div>
        <div className='flex flex-col justify-center border border-white shadow-2xl border-2 h-[150px] w-[150px] items-center gap-[6px] bg-gradient-to-b from-[#D1ADFF] to-[#E7D5FF] rounded-full backdrop-blur-[10px] '>
            <h1 className='text-[20px] text-blackText font-[500] leading-[130%] '>
                $1,822.50
            </h1>
